package Atividade_dia_a_dia02.aplicativo;
import Atividade_dia_a_dia02.entidades.Cliente;
import Atividade_dia_a_dia02.entidades.Compra;
import Atividade_dia_a_dia02.entidades.enums.status;
...
public class Main {
    public static void main(String[] args) {
        ...
        sc.nextLine();
        status status= Atividade_dia_a_dia02.entidades.enums.status.INFORMACOES_ADICIONADAS;
        System.out.println(status.getDescricao());

        compra.adicinoraitem();
        status= Atividade_dia_a_dia02.entidades.enums.status.ITEM_ADICIONADO;
        System.out.println(status.getDescricao());
        ...
        if (compra.getPagamento_aceito().equalsIgnoreCase("Sim")){
            ...
            if (compra.getConfirmacao_compra().equalsIgnoreCase("Sim")){
                status= Atividade_dia_a_dia02.entidades.enums.status.COMPRA_REALIZADA_COM_SUCESSO;
                System.out.println(status.getDescricao());
            }
            else {
